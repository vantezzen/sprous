...
it("renders correctly", () => {
  ...
  expect(
    container.querySelector(`[data-testid="layout-search-results"]`)
...
it("switches to search results", () => {
  ...
  fireEvent.change(getByTestId("layout-search-field"), {
    target: { value: "b" },
  })
  ...
  expect(
    container.querySelector(`[data-testid="layout-content"]`)
  ).not.toBeInTheDocument()
})
